  ...
  const benefits = [
    {
      ...
      description: "Atua na vasodilatação e redução do colesterol",
    },
    {
      icon: "fas fa-shield-virus",
      title: "Sistema Imunológico",
      description: "Rico em vitamina C, fortalece as defesas do corpo",
    },
    {
      icon: "fas fa-fire",
      title: "Metabolismo",
      description: "Acelera o metabolismo e auxilia na perda de peso",
    },
    {
      icon: "fas fa-seedling",
      title: "Antioxidante Natural",
      description: "Rico em vitamina E, combate radicais livres",
    },
    {
      icon: "fas fa-bone",
      title: "Saúde Óssea",
      description: "Contém minerais essenciais para ossos e músculos",
    },
    {
      icon: "fas fa-tint",
      title: "Desintoxicante",
      description: "Elimina toxinas e mantém o sistema digestivo saudável",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a
                href="#beneficios"
                className="hover:text-purple-200 font-inter"
              >
                Benefícios
              </a>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Descubra por que o açaí é considerado uma super fruta e como ele
                pode melhorar sua saúde
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-[#4C1D95] rounded-full flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="mt-16 bg-[#4C1D95] rounded-2xl p-8 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>
                      Auxilia na prevenção de câncer e doenças
                      neurodegenerativas
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                    <span>
                      Rico em fibras, melhorando o trânsito intestinal
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                    <span>Combate processos alérgicos e inflamatórios</span>
                  </li>
                </ul>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                    <span>Fonte de energia natural e duradoura</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                    <span>Ajuda na manutenção do peso saudável</span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-400 mt-1 mr-2"></i>
                    <span>Rico em minerais essenciais para o organismo</span>
                  </li>
                </ul>
              </div>
            </div>
